                ...
                >
                  ...
                  <div className="flex items-center space-x-2">
                    <div className="flex items-center space-x-1 rounded-full border border-gray-300 p-1">
                      ...
                      <span className="w-6 text-center text-gray-600 text-sm font-medium">
                        {item.quantity}
                      </span>
                      <button
                    ...
                    <button
                      ...
                      className="flex h-8 w-8 items-center justify-center rounded-full bg-red-800 text-white transition-colors hover:bg-red-600"
